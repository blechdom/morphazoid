...
test("the MIDI requirement declaration accounts for all 116 catalogue instruments", async ({}, testInfo) => {
  ...
  expect(INSTRUMENTS).toHaveLength(116);
  expect(INSTRUMENT_MIDI_CAPABILITIES).toHaveLength(116);
  expect(capabilitiesById.size).toBe(116);
