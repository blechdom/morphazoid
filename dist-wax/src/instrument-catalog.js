...
const CATALOG_DETAILS = Object.freeze({
  ...
  "hiccup-head": define(
    ...
    "Moves a softly translucent, step-shifting pastel-rainbow checkerboard polka-dot goofball face and one persistent Pink Trombone–lineage oral waveguide between thirty-nine exclusive gestures, including HIC! and EEF! breaths, KISS, a BRUSH tooth gliss, mouth KSH snare, tongue snap, cheek toms, BRRAP, resonant face claps, open-throat and rough voices, grunt, moan, rolling LA and R, PB-PB, a wet pull-out tongue, missing-incisor FWEE, and twelve pitched dead-wood teeth.",
    "Tap any of thirty-nine feature-clear sound dots, the whistle gap, or twelve separately pitched crooked teeth. KISS leaves a fading lip print at a changing face position, BRUSH sends a visible toothbrush across the wood-toned teeth, and blue slap mitts appear only while SLAP or SMACK is dragged. Pull either horizontal-tethered ear for stereo width, and drag each straight side-hair tip in two dimensions—length sets echo amount while angle sets that side's delay time. Matched circular eyes move inward for bright plate reverb, outward for a dark cathedral, and downward to thicken the room; centered open eyes are dry. Use two thick eyebrows as a cyclic sequence-amplitude contour. The large glossy #FF0000 circular nose controls the nasal branch, while the oval green, translucent-striped lips become thinner as the mouth opens. Persistent Delay, Reverb, Nasal, and Stereo switches and live amounts stay put through preset changes, mutation, and reset. Sequence one gesture per column at any length from 1 through 64 steps and up to 520 BPM, then mutate one to eight sequential voice characters without layering mouths.",
    ["Built-in source", "Pointer", "Computer keys"],
  ),
  "breath-atlas": define(
