...
import { normalizeRoachSound, ROACH_SOUND_DEFAULTS, normalizeRoachBodyMix, createDefaultRoachBodyMix } from './roach-synth-dsp.js?v=291f01aef669';
import { RoachMidiPerformance, normalizeRoachMidiMessage } from './roach-synth-midi.js?v=291f01aef669';
...
export { ROACH_SOUND_DEFAULTS, ROACH_SOUND_PRESETS, ROACH_MOD_TARGETS,
  ...
  ROACH_MOTION_SOUND_PRESETS, getRoachMotionSound } from './roach-synth-dsp.js?v=291f01aef669';
...
export class RoachSynthAudio {
  ...
  async build(context) {
    ...
    this.buildPromise = (async () => {
      ...
      await context.audioWorklet.addModule(new URL('./roach-synth-processor.js?v=291f01aef669', import.meta.url));
