import { createSpiderWeb, normalizeSpiderWeb, spiderWebGeometryKey, serializeSpiderWeb } from './spider-synth-web.js?v=dd1be907fd5b';
import { SpiderSynthWorld } from './spider-synth-world.js?v=dd1be907fd5b';
...
import { normalizeSpiderSound, SPIDER_SOUND_DEFAULTS, normalizeSpiderBodyMix, createDefaultSpiderBodyMix } from './spider-synth-dsp.js?v=dd1be907fd5b';
import { SpiderMidiPerformance, normalizeSpiderMidiMessage } from './spider-synth-midi.js?v=dd1be907fd5b';
import { SPIDER_RECORDINGS } from './spider-synth-recordings.js?v=dd1be907fd5b';
...
export { SPIDER_SOUND_DEFAULTS, SPIDER_SOUND_PRESETS, SPIDER_BODY_GROUPS, SPIDER_BODY_SOURCES,
  ...
  SPIDER_MOTION_SOUND_PRESETS, getSpiderMotionSound, getSpiderBodyGroupId } from './spider-synth-dsp.js?v=dd1be907fd5b';
...
export class SpiderSynthAudio {
  ...
  async build(context) {
    ...
    this.buildPromise = (async () => {
      ...
      await context.audioWorklet.addModule(new URL('./spider-synth-processor.js?v=dd1be907fd5b', import.meta.url));
