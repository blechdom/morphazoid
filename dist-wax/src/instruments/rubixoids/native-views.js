        ...
        <details class="group control-section sliding-control-section" data-section="clock" open>
          ...
          <div class="group-body">
            ...
            <div class="sliding-tempo-row">
              ...
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8M3 3v5h5" /></svg>
              </button>
            </div>
  ...
  <div class="rubixoids-native-controls" hidden aria-hidden="true">
    ...
    <main class="shell rubix-shell" id="rubixSequencer">
      ...
      <aside class="panel rubix-panel" aria-label="Rubix Cube Sequencer controls">
        <div hidden aria-hidden="true"><b id="engineState"></b><small id="sequenceState"></small></div>

        <section class="puzzle-performance" aria-label="Playback and motion">
          <div class="position-row puzzle-play-row">
            <button class="play-button" id="playButton" aria-labelledby="playLabel" type="button" aria-pressed="false">
                <svg class="transport-play" viewBox="0 0 24 24" aria-hidden="true"><path d="M8 5.5 18 12 8 18.5Z" /></svg>
                <svg class="transport-pause" viewBox="0 0 24 24" aria-hidden="true"><path d="M8 6v12M16 6v12" /></svg>
                <span class="sr-only"><b id="playLabel">Play cube</b><small id="playState">9-step loop</small></span>
              </button>
            <div class="puzzle-tempo-control"><label class="control" for="tempo">
          ...
          <div class="puzzle-swing-row"><label class="control" for="swing">
              <span><b>Swing</b><output id="swingOut" for="swing">0%</output></span>
              <input id="swing" type="range" min="0" max="0.42" step="0.01" value="0" />
            </label></div>
          <div class="position-row puzzle-twist-row"><button id="randomTwists" class="play-button" type="button" aria-pressed="false" aria-label="Start random twists" title="Start random twists">
                ...
                <span class="sr-only"><b>Twists</b><small id="randomTwistState">off</small></span>
              </button><label class="control" for="randomTwistSpeed">
                <span>
                  <b>Twists</b>
          ...
          <label class="select-control puzzle-read-path" for="readPath">
            <span class="field-label">Read path</span>
            <span class="select-shell"><select id="readPath" aria-label="Read path">
              <option value="parallel" selected>Rows</option>
        ...
        <label
            ...
            >
              ...
              <input
                ...
                value="1"
              />
            </label></section><div hidden aria-hidden="true">
          <span id="clockSummary"></span><span id="readModeState"></span>
          <div id="stepStrip" hidden></div><span id="acidNow"></span><span id="drumNow"></span>
          <small id="randomTwistHelp">Automatic movement speed, independent of tempo.</small>
        ...
        <div hidden aria-hidden="true"><span id="scoreSummary"></span><p id="scoreDescription"></p><div id="laneList" hidden></div><div id="colorKey" hidden></div></div>
      ...
      <p class="sr-only" id="cubeInstructions">
        ...
        with Read path to change how the visible stickers are read. Alternate
      ...
      <aside class="panel hyper-rubix-panel" aria-label="Hyper Rubix controls">
        <section class="puzzle-performance" aria-label="Playback and motion">
          <div class="position-row puzzle-play-row">
            <button
                class="play-button"
                id="playButton" aria-labelledby="playLabel"
                type="button"
                aria-pressed="false"
              ...
              >
                <svg class="transport-play" viewBox="0 0 24 24" aria-hidden="true"><path d="M8 5.5 18 12 8 18.5Z" /></svg>
                <svg class="transport-pause" viewBox="0 0 24 24" aria-hidden="true"><path d="M8 6v12M16 6v12" /></svg>
                <span class="sr-only"><b id="playLabel">Play shape loop</b><small id="playState">108 view-facing stickers · one note each</small></span>
              </button>
            <div class="puzzle-tempo-control"><label class="control" for="tempo">
          ...
          <div class="position-row puzzle-twist-row"><button class="play-button" id="twistPlayButton" type="button" aria-pressed="false" aria-label="Start twists" title="Start twists" disabled>
            <svg class="transport-play" viewBox="0 0 24 24" aria-hidden="true"><path d="M8 5.5 18 12 8 18.5Z" /></svg>
            <svg class="transport-pause" viewBox="0 0 24 24" aria-hidden="true"><path d="M8 6v12M16 6v12" /></svg>
          </button><label class="select-control" for="twistMotion">
                <span class="field-label">Twists</span>
                <span class="select-shell">
                  <select id="twistMotion" aria-describedby="twistMotionHelp" disabled>
                    <option value="auto">Auto</option>
                    <option value="beat">Per beat</option>
                    <option value="bar">Per bar</option>
          ...
          <label class="select-control hyper-rubix-method-select" for="sequenceMethod">
              ...
              <span class="select-shell">
                <select id="sequenceMethod" aria-describedby="sequenceMethodHelp">
                  <option value="sticker-stream" selected id="stickerStreamMethodOption">Sticker loop</option>
                  <option id="cornerStreamMethodOption" value="corner-stream">Corner stream</option>
                  <option id="stickerHyperbarMethodOption" value="sticker-hyperbar">Hyperbar</option>
                  <option id="hybridCoilMethodOption" value="hybrid-coil">Hybrid coil</option>
                  <option value="twist-tape">Twist tape</option>
                </select>
              </span>
              <small id="sequenceMethodHelp" hidden>Every sticker sounds once in a fixed forward loop.</small>
            </label>
        </section>
        ...
        <details class="group control-section hyper-rubix-control-section" data-section="sequence" open>
          <summary class="group-summary">
            ...
            <span class="section-state" id="clockSummary" hidden>108 notes · 112 BPM · 1/8</span>
          </summary>
          <div class="group-body">
        ...
        <details class="group control-section hyper-rubix-control-section" data-section="twist" open>
          ...
          <div class="group-body"><div class="hyper-rubix-status" aria-label="Puzzle status">
          <div>
