import { createSpiderWeb, normalizeSpiderWeb, spiderWebGeometryKey, serializeSpiderWeb } from './spider-synth-web.js?v=230f9505a484';
import { SpiderSynthWorld } from './spider-synth-world.js?v=230f9505a484';
...
import { normalizeSpiderSound, SPIDER_SOUND_DEFAULTS, normalizeSpiderBodyMix, createDefaultSpiderBodyMix } from './spider-synth-dsp.js?v=230f9505a484';
import { SpiderMidiPerformance, normalizeSpiderMidiMessage } from './spider-synth-midi.js?v=230f9505a484';
import { SPIDER_RECORDINGS } from './spider-synth-recordings.js?v=230f9505a484';
...
export { SPIDER_SOUND_DEFAULTS, SPIDER_SOUND_PRESETS, SPIDER_BODY_GROUPS, SPIDER_BODY_SOURCES,
  ...
  SPIDER_MOTION_SOUND_PRESETS, getSpiderMotionSound, getSpiderBodyGroupId } from './spider-synth-dsp.js?v=230f9505a484';
...
export class SpiderSynthAudio {
  ...
  async build(context) {
    ...
    this.buildPromise = (async () => {
      ...
      await context.audioWorklet.addModule(new URL('./spider-synth-processor.js?v=230f9505a484', import.meta.url));
