...
export const SHADER_SYNTH_PRIMITIVE_COVERAGE = freeze({
  ...
  "ambisonic-encode": playable("spatializer", "Directional Spatializer", "FOA-style field approximation"),
  ...
  "phase-vocoder": playable("spectral-transport", "Spectral Transport", "32-band resonator approximation"),
  ...
  "partitioned-convolution": playable("convolution-space", "Convolution Space", "Staged sparse-tap prototype"),
  "feedback-delay-network": playable("feedback-network", "Feedback Network", "Recirculating 4/8-tap field approximation"),
  "large-grain-engine": playable("gpu-sampler-granulator", "GPU Sampler / Granulator", "Bounded 24-grain loop"),
  ...
  "hrtf-binaural-convolution": playable("spatializer", "Directional Spatializer", "Analytic binaural-cue approximation"),
  "ambisonic-decode": playable("spatializer", "Directional Spatializer", "FOA-style stereo decode"),
  "sliding-phase-vocoder": playable("spectral-transport", "Spectral Transport", "Sliding 32-band phase approximation"),
  "spectral-gate": playable("spectral-gate", "Spectral Gate"),
  "audio-analysis-texture": playable("audio-analysis-field", "Audio Analysis Field", "Waveform ring + scalar probes"),
  ...
  "hybrid-convolution": playable("convolution-space", "Convolution Space", "Hybrid sparse-tap prototype"),
  ...
  "vocoder-cross-synthesis": playable("spectral-vocoder", "Cross-Synthesis Vocoder", "32-channel filter-bank vocoder"),
  "lookahead-limiter": playable("dynamics", "Dynamics", "Look-ahead limiter"),
  "neural-dilated-convolution": playable("neural-processor", "Neural Processor", "Fixed-weight dilated network"),
  "neural-recurrent-model": playable("neural-processor", "Neural Processor", "Compact recurrent network"),
