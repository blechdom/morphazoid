...
`rubixoids.html` is one app page containing the full Sliding Puzzle (2D), Rubix Cube (3D) and Hyper Rubix (4D) instruments. It opens in 3D. The dimension selector and shared Play control sit below the main Morphazoid menu. Direct links accept `?dimension=2d`, `?dimension=3d`, or `?dimension=4d`.
