...
- Keep the microphone Graph Delay at 3–24 nodes and 192 relative-turn routes. The event instruments retain their complete requested graph at 3–128 nodes; audio attack thinning, scheduler limits, and dense drawing batches must never mutate its nodes or routes.
...
- a dense cyclic 128-node schedule stays bounded and deterministic, keeps fixed-width path hashes, and leaves its generated topology unchanged;
