...
} from "./src/hiccup-head.js?v=e6a50de821d4";
...
const HICCUP_HEAD_VISUAL_SKINS = Object.freeze([
  ...
  Object.freeze({
    ...
    mode: "atlas",
    asset: "./assets/hiccup-head/skins/cut-paper-collage.webp?v=c93748f72f5c",
    fieldAsset: "./assets/hiccup-head/skins/vintage-magazine-face-fields.webp?v=4c593170499e",
  }),
  Object.freeze({
    id: "photo-1904",
    ...
    mode: "atlas",
    asset: "./assets/hiccup-head/skins/portrait-1904.webp?v=c1449dffd1a7",
  }),
  Object.freeze({
    id: "food-portrait",
    label: "Food portrait",
    ...
    mode: "atlas",
    asset: "./assets/hiccup-head/skins/pantry-portrait.webp?v=69fa45f93400",
  }),
  Object.freeze({
    id: "ascii",
  ...
  Object.freeze({
    ...
    mode: "ink",
    fieldAsset: "./assets/hiccup-head/skins/wild-ink-decay-fields.webp?v=b0506cf7bd2b",
  }),
]);
...
const WARM_ROOM_IMPULSE_URLS = Object.freeze({
  plate: new URL(
    "./assets/audio/hiccup-head-emt140-warm-plate.wav?v=a41910c0eb49",
    import.meta.url,
  ),
  cathedral: new URL(
    "./assets/audio/hiccup-head-york-minster-warm-hall.wav?v=d62e40ecbca2",
    import.meta.url,
  ),
});
  ...
  try {
    [, , warmRoomBuffers] = await Promise.all([
      ...
      context.audioWorklet.addModule(new URL(
        "./src/hiccup-head-processor.js?v=150aee324f2c",
        import.meta.url,
      )),
