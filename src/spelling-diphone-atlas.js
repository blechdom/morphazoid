...
function clip(offset, duration, gain = 1, kind = "consonant", phone = "") {
...
export const SPELLING_DIPHONE_CLIPS = Object.freeze({
  ...
  o: clip(2.994562, 0.5425, 1, "vowel", "AA"),
  ...
  u: clip(4.5095, 0.497437, 1, "vowel", "AH"),
