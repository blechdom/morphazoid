...
const CORE_CONSONANTS = Object.freeze({
  ...
  th: freezeConsonant("th", {
    ...
    glottalClosure: 0,
    nasalCoupling: 0,
    frication: { frequency: 4_650, q: 0.64, gain: 0.58 },
    burst: {
      frequency: 4_100,
      q: 0.7,
      gain: 0,
    ...
    nasal: { poleFrequency: 255, notchFrequency: 1_180, q: 3.2, gain: 0 },
    gesture: T_GESTURE,
  }),
  dh: freezeConsonant("dh", {
    symbol: "DH",
    name: "Voiced TH",
    manner: "fricative",
    place: "dental",
    ...
    glottalClosure: 0,
    nasalCoupling: 0,
    frication: { frequency: 4_050, q: 0.58, gain: 0.38 },
    burst: {
      frequency: 3_700,
      q: 0.68,
      gain: 0,
