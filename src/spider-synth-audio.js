...
export { SPIDER_SOUND_DEFAULTS, SPIDER_SOUND_PRESETS, SPIDER_BODY_GROUPS, SPIDER_BODY_SOURCES,
  ...
  SPIDER_MOTION_SOUND_PRESETS, getSpiderMotionSound, getSpiderBodyGroupId } from './spider-synth-dsp.js';
...
export class SpiderSynthAudio {
  ...
  async build(context) {
    ...
    this.buildPromise = (async () => {
      ...
      await context.audioWorklet.addModule(new URL('./spider-synth-processor.js', import.meta.url));
