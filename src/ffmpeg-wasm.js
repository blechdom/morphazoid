...
export const RECIPES = Object.freeze([
  Object.freeze({
    ...
    label: "Clean relay",
    filter: "anull",
    description: "A format round-trip through FFmpeg with no creative filter.",
  }),
  Object.freeze({
    id: "telephone",
    label: "Pocket telephone",
    filter: "highpass=f=350,lowpass=f=3200,acompressor=threshold=0.1:ratio=3:attack=15:release=180",
    description: "A narrow, compressed communications-band voice.",
  }),
  Object.freeze({
    id: "tremolo",
    label: "Machine tremolo",
    filter: "tremolo=f=6:d=0.72",
    description: "A six-hertz amplitude chop generated by FFmpeg's tremolo filter.",
  }),
  Object.freeze({
    id: "crusher",
    label: "Seven-bit crusher",
    filter: "acrusher=bits=7:mix=0.72:mode=lin",
    description: "A deliberately reduced-resolution digital rasp.",
  }),
  Object.freeze({
    id: "reverse",
    label: "Window reverse",
    filter: "areverse",
    description: "Each captured window plays backward, making the chunk boundary audible.",
  }),
]);
