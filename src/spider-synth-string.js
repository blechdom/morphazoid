  ...
  sample(levels, brightness) {
    ...
    for (const voice of this.voices) {
      ...
      if (voice.burst > 0) {
        ...
        const t = 1 - voice.burst / voice.burstLength;
        ...
        excitation = (voice.noise * .75 + (triangle - .5) * .5) * voice.amplitude;
        if (voice.material === 3) excitation += Math.sin(TAU * t * 7) * voice.amplitude * .12;
