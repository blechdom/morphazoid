...
const ADDED_SCENES = [
  ...
  { id: "foot-corkscrew", label: "Corkscrew toes", form: "foot", pose: "source-open", foot: { arch: 26, twist: -24, stretch: .32 },
    ...
    appearance: { skin: 0.93, lighting: 0.67 }, view: { yaw: -1.38, pitch: .32, zoom: .8 }, tremor: { finger: "all", joint: "spread", amount: 24, rate: 47, rateSpread: .81, phaseSpread: .38 } },
  ...
  { id: "foot-beetle-step", label: "Beetle step", form: "foot", pose: "claw", foot: { arch: -16, twist: 18, stretch: .1 },
    ...
    appearance: { skin: 0.82, lighting: 0.06 }, view: { yaw: -1.8, pitch: .18, zoom: .89 }, tremor: { finger: "all", joint: "middle", amount: 12.4, rate: 10.8, rateSpread: .24, phaseSpread: .83 } },
