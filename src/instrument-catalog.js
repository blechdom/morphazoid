...
const CATALOG_DETAILS = Object.freeze({
  ...
  "hiccup-head": define(
    ...
    "Moves a 40%-opaque, step-shifting checkerboard polka-dot goofball face and one persistent Pink Trombone–lineage oral waveguide between thirty-seven exclusive gestures, including HIC! and EEF! breaths, mouth KSH snare, tongue snap, low and high cheek toms, BRRAP, resonant rubber-hand claps, open-throat and rough voices, grunt, moan, rolling LA and R, PB-PB, a wet pull-out tongue, missing-incisor FWEE, and twelve pitched dead-wood teeth.",
    "Tap any of thirty-seven feature-clear sound dots, the whistle gap, or twelve separately pitched crooked teeth; drag the larger rubbery hands to slap, pull either horizontal-tethered ear for stereo width, and drag each straight side-hair tip in two dimensions—length sets echo amount while angle sets that side's delay time. Pull the eyes outward for reverb; crossed eyes and closed lids stay visual only. Use two thick eyebrows as a cyclic sequence-amplitude contour. The glossy square nose controls the nasal branch, while the green, translucent-striped lips become thinner as the mouth expands. Persistent Delay, Reverb, Nasal, and Stereo switches and live amounts stay put through preset changes, mutation, and reset. Sequence one gesture per column at any length from 1 through 64 steps and up to 520 BPM, then mutate one to eight sequential voice characters without layering mouths.",
    ["Built-in source", "Pointer", "Computer keys"],
  ),
  "breath-atlas": define(
