...
`wax/wax-host-bootstrap.js`, `wax/wax-host-bridge.js`, and one early bootstrap
...
The rest of the catalog is already navigable and audible through WAX's browser
and Web Audio bridge, but it does not yet claim page-specific DataTree,
transport, automatic MIDI, or closed-editor behavior. Each instrument will add
an explicit adapter as its state and timing semantics are validated.
...
CC back to WAX. Only user-originated control changes send automation CC output.
...
- [WAX Developer Documentation](https://audiofusion.com/docs/wax-developer-documentation/)
