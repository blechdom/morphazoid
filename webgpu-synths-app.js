import {
  ...
  webGpuSynthSupport,
} from "./src/webgpu-synths.js?v=20260826-phase-safe-presets";
...
// Keep the source library stable, then present a reproducible tonal-first shuffle
// with Modal Bloom featured and the deliberately destructive patches grouped last.
const PRESET_LIBRARY = Object.freeze([
  ...
  preset("lunar-bells", "Lunar Bells", "orbit", 0.12, { topology: 3, baseNote: 67, clock: 7.2, steps: 15, glide: 0.08, complexity: 0.58, color: 0.5, motion: 0.15, decay: 1.62, fold: 0.04, space: 0.94, chaos: 0.04, gain: 0.084, seed: 8271, scale: 4, modalModes: 10, filterCutoff: 9000, filterTaps: 13, filterMix: 0.18, delayTime: 0.56, delayRepeats: 4, delayDecay: 0.62, delayMix: 0.28 }),
  ...
  preset("modal-bloom", "Modal Bloom", "recurrence", 0.14, { topology: 3, baseNote: 52, clock: 9.8, steps: 27, glide: 0.24, complexity: 0.7, color: 0.48, motion: 0.2, decay: 1.48, fold: 0.06, space: 0.82, chaos: 0.07, gain: 0.09, seed: 14417, scale: 3, modalModes: 16, filterCutoff: 8200, filterTaps: 13, filterMix: 0.2, delayTime: 0.29, delayRepeats: 2, delayMix: 0.13 }),
  ...
  preset("bell-swarm", "Bell Swarm", "orbit", 0.2, { topology: 3, baseNote: 46, clock: 2.7, steps: 20, glide: 0, complexity: 0.78, color: 0.6, motion: 0.25, decay: 1.22, fold: 0.1, space: 0.9, chaos: 0.12, swing: 0.02, gain: 0.1, seed: 8271, scale: 4, modalModes: 14, filterCutoff: 9600, filterTaps: 11, filterMix: 0.12, delayTime: 0.37, delayRepeats: 4, delayDecay: 0.63, delayMix: 0.34 }),
  ...
  preset("grain-halo", "Grain Halo", "brownian", 0.4, { topology: 4, baseNote: 44, clock: 3.7, steps: 40, glide: 0.48, complexity: 0.7, color: 0.42, motion: 0.65, decay: 0.9, fold: 0.12, space: 1, chaos: 0.34, swing: 0.22, gain: 0.086, seed: 47231, scale: 5, grainCount: 8, filterCutoff: 10000, filterTaps: 11, filterMix: 0.2, delayTime: 0.43, delayRepeats: 4, delayDecay: 0.74, delayMix: 0.32 }),
  preset("modal-wire", "Modal Wire", "recurrence", 0.46, { topology: 3, baseNote: 33, clock: 5.9, steps: 26, glide: 0.04, complexity: 0.88, color: 0.68, motion: 0.3, decay: 0.72, fold: 0.32, space: 0.84, chaos: 0.36, swing: 0.11, gain: 0.084, seed: 50147, scale: 2, modalModes: 18, filterCutoff: 8000, filterTaps: 19, filterMix: 0.24, shaperDrive: 2.6, shaperMix: 0.12 }),
  preset("clockwork-dust", "Clockwork Dust", "cellular", 0.5, { topology: 4, baseNote: 26, clock: 12.4, steps: 48, glide: 0.18, complexity: 0.78, color: 0.38, motion: 0.58, decay: 0.24, fold: 0.22, space: 0.72, chaos: 0.42, swing: 0.24, gain: 0.086, seed: 53719, scale: 0, grainCount: 8, filterCutoff: 6200, filterTaps: 21, filterMix: 0.36, delayTime: 0.08, delayRepeats: 3, delayMix: 0.14 }),
  preset("particle-rain", "Particle Rain", "orbit", 0.52, { topology: 4, baseNote: 58, clock: 4.3, steps: 56, glide: 0.54, complexity: 0.82, color: 0.46, motion: 0.72, decay: 0.72, fold: 0.12, space: 1, chaos: 0.4, swing: 0.29, gain: 0.076, seed: 57037, scale: 4, grainCount: 10, filterCutoff: 11200, filterTaps: 9, filterMix: 0.16, delayTime: 0.67, delayRepeats: 4, delayDecay: 0.8, delayMix: 0.32 }),
  ...
  preset("dust-engine", "Dust Engine", "brownian", 0.46, { topology: 4, baseNote: 27, clock: 7.7, steps: 24, glide: 0.42, complexity: 0.78, color: 0.44, motion: 0.62, decay: 0.46, fold: 0.24, space: 0.94, chaos: 0.48, swing: 0.21, gain: 0.09, seed: 51733, scale: 1, grainCount: 9, filterCutoff: 7000, filterTaps: 17, filterMix: 0.31, delayTime: 0.11, delayRepeats: 2, delayMix: 0.16 }),
  ...
  preset("noise-lattice", "Noise Lattice", "noise", 0.8, { topology: 4, baseNote: 23, clock: 13.1, steps: 64, glide: 0.14, complexity: 1, color: 0.68, motion: 1, decay: 0.12, fold: 0.78, space: 0.92, chaos: 0.92, swing: 0.38, gain: 0.06, seed: 62011, scale: 0, grainCount: 16, filterCutoff: 2300, filterTaps: 31, filterMix: 0.62, delayTime: 0.047, delayRepeats: 4, delayDecay: 0.82, delayMix: 0.32 }),
  ...
  preset("shrapnel-fold", "Shrapnel Fold", "cellular", 0.88, { topology: 2, baseNote: 62, clock: 16.2, steps: 60, glide: 0.01, complexity: 0.92, color: 0.78, motion: 0.88, decay: 0.08, fold: 0.82, space: 0.9, chaos: 0.84, swing: 0.3, gain: 0.056, seed: 63809, scale: 5, foldLayers: 6, filterCutoff: 12800, filterTaps: 7, filterMix: 0.12, shaperDrive: 6.2, shaperFold: 0.82, shaperMix: 0.45 }),
  ...
  preset("void-grinder", "Void Grinder", "noise", 1, { topology: 2, baseNote: 18, clock: 18, steps: 64, glide: 0.72, complexity: 1, color: 0.12, motion: 0.92, decay: 0.04, fold: 0.88, space: 1, chaos: 1, swing: 0.42, gain: 0.048, seed: 65535, scale: 5, foldLayers: 8, filterCutoff: 620, filterTaps: 31, filterMix: 0.76, delayTime: 0.019, delayRepeats: 4, delayDecay: 0.88, delayMix: 0.5, shaperDrive: 9.5, shaperFold: 0.88, shaperMix: 0.65 }),
]);

const INTENTIONAL_NOISE_PRESET_IDS = Object.freeze([
  "static-choir",
  "folded-mutant",
  "copper-fold",
  "interzone",
...
function shuffledPresetBank(presets, seed = 0x4d4f5250) {
  ...
  const remainder = presets.filter((candidate) => candidate !== featured);
  const tonal = remainder.filter(({ id }) => !INTENTIONAL_NOISE_PRESET_IDS.includes(id));
  const destructive = remainder.filter(({ id }) => INTENTIONAL_NOISE_PRESET_IDS.includes(id));
  return Object.freeze([featured, ...shuffle(tonal), ...shuffle(destructive)]);
}
