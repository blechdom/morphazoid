...
The pure model lives in `src/instruments/throat-singing/throat-singing.js`. Its named values are immutable starting points and carry approximation notices.
