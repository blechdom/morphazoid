...
var SoundTouchProcessorBase = class extends AudioWorkletProcessor {
	...
	_underrunCount = 0;
	/** True after the algorithm has supplied its first complete output block. */
	_outputPrimed = false;
	...
	*/
	processCore(inputs, outputs, parameters) {
		...
		this._blockCount++;
		if (available >= frameCount) this._outputPrimed = true;
		else if (this._outputPrimed) this._underrunCount++;
