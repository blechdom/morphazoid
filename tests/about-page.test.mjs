...
import { INSTRUMENT_GROUPS, INSTRUMENTS } from "../src/site/instrument-catalog.js";
...
test("MIDI and WAX guide keeps browser MIDI and DAW plug-in routing clear", async () => {
  ...
  assert.match(visibleText, /Click or tap the gear at the top right to update audio and MIDI settings while keeping the instrument open behind it/);
