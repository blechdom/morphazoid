...
test("site builder publishes runtime files without development material", async () => {
  ...
  try {
    ...
    for (const path of [
      ...
      "dist-wax/hambone.html",
      "dist-wax/hambone.css",
      "dist-wax/hambone-app.js",
      "dist-wax/src/hambone.js",
      "dist-wax/src/hambone-processor.js",
      "dist-wax/assets/instruments/hambone.webp",
