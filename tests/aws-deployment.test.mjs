...
test("site builder publishes runtime files without development material", async () => {
  ...
  try {
    ...
    for (const path of [
      ...
      "dist-wax/simd-audio-lab.html",
      "dist-wax/simd-resonator.css",
      "dist-wax/simd-resonator-app.js",
      ...
      "dist-wax/simd-303.css",
      "dist-wax/simd-303-app.js",
      ...
      "dist-wax/simd-synth.css",
      "dist-wax/simd-synth-app.js",
