...
test("site builder publishes runtime files without development material", async () => {
  ...
  try {
    ...
    for (const path of [
      ...
      "dist-wax/moebius.html",
      "dist-wax/klein-bottle.html",
      "dist-wax/nonorientable.css",
      "dist-wax/nonorientable-app.js",
      "dist-wax/src/nonorientable-surface.js",
      ...
      "dist-wax/quadruped.css",
      "dist-wax/quadruped-app.js",
      "dist-wax/src/quadruped.js",
      ...
      "dist-wax/yoyodyne.css",
      "dist-wax/yoyodyne-app.js",
      "dist-wax/src/yoyodyne.js",
      "dist-wax/src/yoyodyne-audio.js",
      ...
      "dist-wax/webgpu-chiptune.css",
      "dist-wax/webgpu-chiptune-app.js",
      "dist-wax/src/webgpu-chiptune.js",
      ...
      "dist-wax/ffmpeg-wasm.html",
      "dist-wax/ffmpeg-wasm.css",
      "dist-wax/ffmpeg-wasm-app.js",
      "dist-wax/src/ffmpeg-wasm.js",
      "dist-wax/src/ffmpeg-wasm-capture-processor.js",
      "dist-wax/assets/instruments/ffmpeg-wasm.webp",
      "dist-wax/vendor/ffmpeg-wasm/ffmpeg/classes.js",
      "dist-wax/vendor/ffmpeg-wasm/ffmpeg/const.js",
      "dist-wax/vendor/ffmpeg-wasm/ffmpeg/errors.js",
      "dist-wax/vendor/ffmpeg-wasm/ffmpeg/index.js",
      "dist-wax/vendor/ffmpeg-wasm/ffmpeg/types.js",
      "dist-wax/vendor/ffmpeg-wasm/ffmpeg/utils.js",
      "dist-wax/vendor/ffmpeg-wasm/ffmpeg/worker.js",
      "dist-wax/vendor/ffmpeg-wasm/LICENSE",
      "dist-wax/vendor/ffmpeg-wasm/core/COPYING.GPLv2",
      "dist-wax/vendor/ffmpeg-wasm/core/README.md",
      "moire-drone.html",
      "moire-drone.css",
      "moire-drone-app.js",
      "src/moire-drone.js",
    ...
    for (const path of [
      ...
      "dist-wax/vendor/ffmpeg-wasm/core/ffmpeg-core.js",
      "dist-wax/vendor/ffmpeg-wasm/core/ffmpeg-core.wasm",
    ]) {
